...
CreateThread(function()
    ...
    MySQL.query([[
        CREATE TABLE IF NOT EXISTS `faction_territory` (
            ...
            `stash_access` TEXT DEFAULT NULL,
    ...
    -- Migration: add stash_access column for existing tables
    MySQL.query([[
        ALTER TABLE `faction_territory`
        ADD COLUMN IF NOT EXISTS `stash_access` TEXT DEFAULT NULL
    ]])
